 ...
 * @property Collection<UserMemberOfGroup> memberOf
 *
...
class User extends Authenticatable implements FilamentUser
{
    ...
    {
        return $this->hasMany(UserMemberOfGroup::class);
    }
...
//        return $this->createPasswordResetToken();
    ...
    {
        $this->memberOf->each(function(UserMemberOfGroup $memberOf) {
            $memberOf->delete();
        });
    ...
    public function canDo(mixed $privilege, Model $record = null) {
        return app(\Mediamouse\Users\UserCan\UserCan::class)->check($this, $privilege, $record);
    }
}
